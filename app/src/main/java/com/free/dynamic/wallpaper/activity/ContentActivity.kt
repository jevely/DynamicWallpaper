...
import com.free.dynamic.wallpaper.service.VideoLiveWallpaper
import com.free.dynamic.wallpaper.service.VideoLiveWallpaper2
import com.free.dynamic.wallpaper.tool.DataTool
import com.free.dynamic.wallpaper.view.CallThemeBackView
...
class ContentActivity : AppCompatActivity() {
    ...
    private fun isLiveWallpaperChanged(): Boolean {
        val wallpaperManager =
            WallpaperManager.getInstance(this@ContentActivity) // 得到壁纸管理器
        val wallpaperInfo =
